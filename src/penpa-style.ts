...
export function set_surface_style(ctx: any, type: number) {
    ctx.setLineDash([]);
...
export function set_line_style(ctx: any, type: number, ccolor: string = "none") {
    const pu = {size: 1};
    //Initialization
    ctx.setLineDash([]);
    ctx.lineDashOffset = 0;
...
export function set_font_style(ctx: any, size: number, type: number, ccolor: string = "none") {
...
export function set_circle_style(ctx: any, num: number, ccolor: string = "none") {
    ctx.setLineDash([]);
    ctx.lineDashOffset = 0;
    //ctx.lineCap = "butt";
    ctx.strokeStyle = Color.BLACK;
